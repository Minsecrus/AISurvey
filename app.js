  ...
  pages: [
      ...
      elements: [
        {
          ...
          html: `
            <div class="welcome-note">
              <p>亲爱的同学：</p>
              <p>您好！本问卷想了解使用生成式 AI 工具时的真实体验，包括 AI 使用情况、同伴比较、学习压力，以及对高级 AI 服务的态度。</p>
    ...
    },
    {
      ...
      elements: [
        ...
        choiceQuestion("q2", "2. 您目前所在年级", ["高中及以下", "大一", "大二", "大三", "大四", "大五及以上", "硕士研究生", "博士研究生", "已就业", "其他"]),
        choiceQuestion("q3", "3. 您所学专业类型", ["人文社科类", "经管类", "理工类", "信息/计算机类", "医学类", "艺术体育类", "其他"]),
        choiceQuestion("q4", "4. 您所在院校类型", ["双一流建设高校", "其他公办本科高校", "民办本科/独立学院", "高职高专院校", "非在校学生", "其他", "不清楚"]),
    ...
    },
    {
      ...
      elements: [
        ...
        choiceQuestion("q14", "14. 您每月用于 AI 工具的实际支出约为", ["0", "1—200元", "201—1400元", "1400元以上"]),
      ],
    },
    {
      name: "peerPerception",
